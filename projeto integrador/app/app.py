...
def perfil():
    return render_template(
        ...
        perfilIA=flask_session.get('perfil_ia', 'Moderado'),
        analiseIA=flask_session.get('analise_ia', '')
    )
...
def formulario3():
    ...
    if request.method == 'POST':
        form_data.update({
            ...
            'perfil_investidor': request.form.get('perfil_investidor', '').strip(),
        ...
        try:
            ...
            perfil_ia = analise.get('perfil', 'Moderado')
            analise_ia = analise.get('analise', '')
        except Exception:
            flash('Não foi possível gerar a análise da IA. Tente novamente mais tarde.', 'error')
        ...
        try:
            ...
            resposta = Resposta(
                ...
                perfil_risco=form_data.get('perfil_investidor', ''),
                perfil_ia=perfil_ia,
